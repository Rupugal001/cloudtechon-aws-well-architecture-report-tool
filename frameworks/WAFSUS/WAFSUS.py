...
class WAFSUS(Framework):
    ...
    def __init__(self, data):
        ...
        waTools = WATools('sustainability')
    ...
    def _hookPostItemsLoop(self):
        ...
        for questionId, opts in self.ResultCache.items():
            ...
            # print(f"[WAFSUS] Updating QuestionId: {questionId} with Choices: {selected_choices}")
            # print(f"[WAFSUS] Failed notes: {failed_notes}")

            try:
                self.WATools.updateAnswers(questionId, selected_choices, unselectedNotes)
            except Exception as e:
                _warn(f"[WAFSUS] Failed to update answers for QuestionId {questionId}: {e}")
