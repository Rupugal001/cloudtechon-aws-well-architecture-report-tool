...
class WATools():
    ...
    def updateAnswers(self, questionId, selectedChoices, unselectedNotes):
        # print(f"Updating answers for questionId: {questionId}, selectedChoices: {selectedChoices}, unselectedNotes: {unselectedNotes}")
        # print(f"hasPermission: {self.HASPERMISSION}")
        if self.HASPERMISSION == False:
            return None
