...
class Lambda(Service):
    def __init__(self, region):
        ...
        self.cloudwatch_client = ssBoto.client("cloudwatch", config=self.bConfig)
        self.tags = []
    ...
    def advise(self):
        ...
        for lambda_function in lambdas:
            ...
            try:
                ...
                obj = LambdaCommon(lambda_function, self.lambda_client, self.iam_client, self.cloudwatch_client, role_count)
