...
class Rds(Service):
    ...
    def advise(self):
        ...
        # print(f"Rds Instance {instances}")
        securityGroupArr = {}
        
        clusters = self.getClusters()
        # print(f'Rds Clusters {clusters}')
        ...
        for instance in groupedResources:
            ...
            print(f'Rds driver_ {driver_}')
            driver = 'Rds' + driver_
            if driver in globals():
                print(f"Rds Common {driver}")
                ...
                common = RdsCommon(instance, self.rdsClient, self.ctClient, self.cwClient)
                common.setEngine(engine)
                common.run(self.__class__)
                objs['Common::' + dbInfo + '=' + instance[dbKey]] = common.getInfo()
                del common
